...
//        sceneController = new GamePlaySceneController(this);
    ...
    private int processServerMessage(String message) {
        ...
        switch (methodName) {
            ...
            case "applyAttackResultGraphic":
                view.menus.GamePlayScene.AttackResultJson result = new Gson().fromJson(JsonParser.parseString(json.get("result").getAsString()).getAsJsonObject(), view.menus.GamePlayScene.AttackResultJson.class);
                playerNumber = Integer.parseInt(json.get("playerNumber").getAsString());
    ...
    public void applyAttackResultGraphic(view.menus.GamePlayScene.AttackResultJson result, int playerNumber, int attackerCardNumber, int defenderCardNumber) {
